...
int main()
{
    int key;
    int nr;
    char fraza [81] = "ANA Russu lucreza cu Nicolai ROTARU, iar Maxim CAZAC - nu Ana.";
	...
	cout << "\n 9.Cuvintele de lungime cel putin 5 litere dintro fraza (ignore)";
	cout << "\n 0.Stop";
	cout << "\n\n\t Alegeti (de la 0 la 8)";
        ...
        switch(key)
        {
            ...
            break;
            case 2:
                ///cout << "Vvdedite frazu -> ";  fflush(stdin);  gets(fraza);
                cout << "Fraza cotoruiu vi vveli s claviatura -> ";
                puts(fraza);
                nr = CuvintePalindroame(fraza, 1);
